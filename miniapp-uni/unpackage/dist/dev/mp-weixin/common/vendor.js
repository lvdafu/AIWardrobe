...
function populateParameters(result) {
  ...
  var parameters = {
    appId: "__UNI__AIWARDROBE",
    appName: "AIWardrobeMini",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"AIWardrobeMini","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 26 */
/*!****************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/pages.json ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 42 */
/*!********************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/api/weather.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var getWeather = function getWeather() {
  var location = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '上海';
  return (0, _request.request)('/api/weather', 'GET', {
    location: location
  });
};
...
/* 43 */
/*!**********************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/utils/request.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
    ...
    uni.request({
      ...
      success: function success(res) {
        if (res.statusCode >= 200 && res.statusCode < 300) {
          ...
          reject(new Error("HTTP ".concat(res.statusCode, ": ").concat(JSON.stringify(res.data))));
        }
      },
      fail: reject
    });
...
/* 44 */
/*!*********************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/utils/config.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 53 */
/*!***************************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/api/recommendation.js ***!
  \***************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var getRecommendation = function getRecommendation() {
  ...
  return (0, _request.request)('/api/recommendation', 'GET', {
...
/* 62 */
/*!*********************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/api/wardrobe.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.getWardrobe = void 0;
var _request = __webpack_require__(/*! ../utils/request */ 43);
var getWardrobe = function getWardrobe() {
  return (0, _request.request)('/api/wardrobe', 'GET');
};
exports.getWardrobe = getWardrobe;
...
/* 71 */
/*!*******************************************************!*\
  !*** D:/owntool/AIWardrobe/miniapp-uni/api/upload.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
exports.uploadClothes = uploadClothes;
var _config = __webpack_require__(/*! ../utils/config */ 44);
function uploadClothes(filePath) {
  return new Promise(function (resolve, reject) {
    uni.uploadFile({
      url: "".concat(_config.BASE_URL, "/api/upload"),
      filePath: filePath,
      name: 'file',
      timeout: 180000,
      success: function success(res) {
        if (res.statusCode >= 200 && res.statusCode < 300) {
          ...
          reject(new Error("\u4E0A\u4F20\u5931\u8D25: ".concat(res.statusCode, " ").concat(res.data)));
        }
      },
      fail: reject
    });
